...
-- Started on 2021-06-29 16:54:12 EDT
...
--
-- TOC entry 3959 (class 1262 OID 16384)
-- Name: uat978; Type: DATABASE; Schema: -; Owner: postgres
--

CREATE DATABASE uat978 WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE = 'en_US.UTF-8';


ALTER DATABASE uat978 OWNER TO postgres;
...
-- Name: uat978; Type: DATABASE PROPERTIES; Schema: -; Owner: postgres
--
...
--
-- TOC entry 3937 (class 0 OID 17409)
-- Dependencies: 207
...
(
    ...
    airspace_ob_ele_desc character varying(50) COLLATE pg_catalog."default" NOT NULL,
    CONSTRAINT airspace_ob_ele_pkey PRIMARY KEY (airspace_ob_ele_id)
)

TABLESPACE pg_default;

ALTER TABLE postgis.airspace_ob_ele
    OWNER to postgres;
...
--
-- TOC entry 3945 (class 0 OID 17690)
-- Dependencies: 215
...
(
    ...
    stop_date character varying COLLATE pg_catalog."default",
    geo_opt integer NOT NULL,
    r_lng integer,
    r_lat integer,
    CONSTRAINT circles_pkey PRIMARY KEY (prod_id, rep_num)
)

TABLESPACE pg_default;

ALTER TABLE postgis.circles
    OWNER to postgres;


--
-- TOC entry 3938 (class 0 OID 17415)
-- Dependencies: 208
...
(
    ...
    fisb_product_desc character varying(50) COLLATE pg_catalog."default" NOT NULL,
    CONSTRAINT fisb_products_pkey PRIMARY KEY (fisb_product_id)
)

TABLESPACE pg_default;

ALTER TABLE postgis.fisb_products
    OWNER to postgres;
...
--
-- TOC entry 3939 (class 0 OID 17421)
-- Dependencies: 209
...
(
    coords geometry,
    ob_ele character varying COLLATE pg_catalog."default",
    rep_num integer NOT NULL,
    prod_id integer NOT NULL,
    start_date character varying COLLATE pg_catalog."default",
    stop_date character varying COLLATE pg_catalog."default",
    ...
    stn_call character(5) COLLATE pg_catalog."default",
    obj_par_val integer,
    obj_param_type integer,
    object_qualifier integer,
    obj_labelt character varying(50) COLLATE pg_catalog."default",
    obj_label integer,
    ...
    segmented integer,
    CONSTRAINT graphics_pkey PRIMARY KEY (alt, rep_num, prod_id, geo_overlay_opt)
)

TABLESPACE pg_default;

ALTER TABLE postgis.graphics
    OWNER to postgres;



--
-- TOC entry 3946 (class 0 OID 17940)
-- Dependencies: 216
...
(
    stn_call character varying(5) COLLATE pg_catalog."default" NOT NULL,
    ob_date character varying COLLATE pg_catalog."default" NOT NULL,
    temp character varying COLLATE pg_catalog."default",
    windsp character varying COLLATE pg_catalog."default",
    winddir character varying COLLATE pg_catalog."default",
    altimeter character varying COLLATE pg_catalog."default",
    visby character varying COLLATE pg_catalog."default",
    dewp character varying COLLATE pg_catalog."default",
    hrly_precip character varying(5) COLLATE pg_catalog."default",
    slp character varying(10) COLLATE pg_catalog."default",
    windvar character varying(10) COLLATE pg_catalog."default",
    windgust character varying(10) COLLATE pg_catalog."default",
    CONSTRAINT metar_new_pkey PRIMARY KEY (ob_date, stn_call)
)

TABLESPACE pg_default;

ALTER TABLE postgis.metar
    OWNER to postgres;


--
-- TOC entry 3948 (class 0 OID 19344)
-- Dependencies: 218
...
(
    ...
    maptime character varying(6) COLLATE pg_catalog."default" NOT NULL,
    ice_sld integer,
    ice_prob integer,
    seq integer,
    CONSTRAINT nexrad_pkey PRIMARY KEY (coords, prod_id, block_num, maptime)
)

TABLESPACE pg_default;

ALTER TABLE postgis.nexrad
    OWNER to postgres;

--
-- TOC entry 3940 (class 0 OID 17441)
-- Dependencies: 210
...
(
    ...
    overlay_geo_opt_desc character varying(50) COLLATE pg_catalog."default" NOT NULL,
    CONSTRAINT overlay_geo_opt_pkey PRIMARY KEY (overlay_geo_opt_id)
)

TABLESPACE pg_default;

ALTER TABLE postgis.overlay_geo_opt
    OWNER to postgres;
...
--
-- TOC entry 3941 (class 0 OID 17447)
-- Dependencies: 211
-- Data for Name: pirep; Type: TABLE DATA; Schema: postgis; Owner: postgres
--
CREATE TABLE postgis.pirep
(
    rep_type character varying(30) COLLATE pg_catalog."default" NOT NULL,
    fl_lev character varying(10) COLLATE pg_catalog."default",
    ac_type character varying(10) COLLATE pg_catalog."default",
    cloud character varying(50) COLLATE pg_catalog."default",
    weather character varying(50) COLLATE pg_catalog."default",
    temperature character varying(20) COLLATE pg_catalog."default",
    wind_spd_dir character varying(30) COLLATE pg_catalog."default",
    turbulence character varying(50) COLLATE pg_catalog."default",
    icing character varying(50) COLLATE pg_catalog."default",
    remarks character varying(100) COLLATE pg_catalog."default",
    location character varying(50) COLLATE pg_catalog."default",
    rep_time character varying(15) COLLATE pg_catalog."default" NOT NULL,
    stn_call character varying(5) COLLATE pg_catalog."default" NOT NULL,
    CONSTRAINT pirep_pkey PRIMARY KEY (stn_call, rep_time)
)

TABLESPACE pg_default;

ALTER TABLE postgis.pirep
    OWNER to postgres;


--
-- TOC entry 3942 (class 0 OID 17450)
-- Dependencies: 212
...
(
    prod_id integer NOT NULL,
    rep_num integer NOT NULL,
    text_data character varying COLLATE pg_catalog."default",
    stn_call character varying(5) COLLATE pg_catalog."default",
    rep_time character varying COLLATE pg_catalog."default",
    segmented integer,
    notam_name character varying(20) COLLATE pg_catalog."default",
    CONSTRAINT sigairmet_pkey PRIMARY KEY (prod_id, rep_num)
)

TABLESPACE pg_default;

ALTER TABLE postgis.sigairmet
    OWNER to postgres;


--
-- TOC entry 3953 (class 0 OID 87181)
-- Dependencies: 223
...
(
    coords geometry NOT NULL,
    stn_call character varying(5) COLLATE pg_catalog."default" NOT NULL,
    stn_loc character varying(75) COLLATE pg_catalog."default" NOT NULL,
    state character(3) COLLATE pg_catalog."default" NOT NULL,
    CONSTRAINT stations_pkey PRIMARY KEY (stn_call)
)

TABLESPACE pg_default;

ALTER TABLE postgis.stations
    OWNER to postgres;
...
--
-- TOC entry 3947 (class 0 OID 18914)
-- Dependencies: 217
...
(
    rep_time character varying COLLATE pg_catalog."default" NOT NULL,
    rep_year integer NOT NULL,
    rep_num integer NOT NULL,
    sched_id integer,
    airsp_id integer,
    sched_status character varying COLLATE pg_catalog."default" NOT NULL,
    airsp_name character varying COLLATE pg_catalog."default",
    ...
    high_alt integer,
    sep_rule character varying COLLATE pg_catalog."default",
    shape_ind character varying COLLATE pg_catalog."default",
    nfdc_id character varying COLLATE pg_catalog."default",
    nfdc_name character varying COLLATE pg_catalog."default",
    dafif_id character varying COLLATE pg_catalog."default",
    dafif_name character varying COLLATE pg_catalog."default",
    airsp_type character varying COLLATE pg_catalog."default",
    low_alt integer,
    CONSTRAINT sua_pkey PRIMARY KEY (rep_num, sched_status)
)

TABLESPACE pg_default;

ALTER TABLE postgis.sua
    OWNER to postgres;

--
-- TOC entry 3950 (class 0 OID 42603)
-- Dependencies: 220
...
(
    ...
    airsp_name character varying(35) COLLATE pg_catalog."default" NOT NULL,
    CONSTRAINT sua_airspace_pkey PRIMARY KEY (airsp_id)
)

TABLESPACE pg_default;

ALTER TABLE postgis.sua_airspace
    OWNER to postgres;
...
INSERT INTO postgis.sua_airspace VALUES ('0103000020E61000000100000004000000F70489EDEE6E51C0795C548B888844402A38BC20222A51C000000000000045400000000000E050C087A3AB7477774540E17A14AE478550C0855E7F129FE94540', 30504, 'AR80(NE)');
INSERT INTO postgis.sua_airspace VALUES ('0103000020E61000000100000003000000E17A14AE478550C0855E7F129FE945400000000000E050C087A3AB74777745402A38BC20222A51C00000000000004540', 30547, 'AR80(SW)');
INSERT INTO postgis.sua_airspace VALUES ('0103000020E6100000010000000600000000000000009058C04529215855754140A39410ACAA0A58C0AC8F87BEBB9B414009FB761211D157C0FA7E6ABC74CB41405D6BEF53559557C0DFC2BAF1EEEE4140909E2287885857C087A3AB7477174240A39410ACAA1A57C0AC8F87BEBB3B4240', 25540, 'AR112H(E)');
INSERT INTO postgis.sua_airspace VALUES ('0103000020E61000000100000006000000A39410ACAA1A57C0AC8F87BEBB3B42405D6BEF53559557C0DFC2BAF1EEEE414009FB761211D157C0FA7E6ABC74CB4140A39410ACAA0A58C0AC8F87BEBB9B414000000000005058C0CDCCCCCCCC8C414000000000009058C04529215855754140', 25541, 'AR112H(W)');
INSERT INTO postgis.sua_airspace VALUES ('0103000020E610000001000000040000008C48145AD68259C0691EC022BFB84240A7EA1ED95C0059C0BE9F1A2FDDEC42406ABC7493188058C096438B6CE71B4340F9A23D5E48EA57C0CD3FFA264D794340', 23944, 'AR116(E)');
INSERT INTO postgis.sua_airspace VALUES ('0103000020E61000000100000005000000F9A23D5E48EA57C0CD3FFA264D794340827170E9986858C0D505BCCCB02B43406ABC7493188058C096438B6CE71B4340A7EA1ED95C0059C0BE9F1A2FDDEC42408C48145AD68259C0691EC022BFB84240', 23945, 'AR116(W)');
INSERT INTO postgis.sua_airspace VALUES ('0103000020E61000000100000005000000CDCCCCCCCC6C52C0DFC2BAF1EEEE45407061DD78770752C0BBD6DEA7AA4A46402A38BC2022A251C0213D450E119146407061DD78776751C00000000000004740D6C743DFDD1D51C0BBD6DEA7AA8A4740', 23996, 'AR212(NE)');
INSERT INTO postgis.sua_airspace VALUES ('0103000020E610000001000000050000002A38BC20228255C0DFC2BAF1EEAE40405915E126A34755C0CDCCCCCCCC14414009FB7612110155C09A99999999B941400000000000E054C05470784144E44140CDCCCCCCCC6C54C0213D450E11514240', 23999, 'AR216(NE)');
INSERT INTO postgis.sua_airspace VALUES ('0103000020E61000000100000005000000CDCCCCCCCC6C54C0213D450E115142400000000000E054C05470784144E4414009FB7612110155C09A99999999B941405915E126A34755C0CDCCCCCCCC1441402A38BC20228255C0DFC2BAF1EEAE4040', 24000, 'AR216(SW)');
INSERT INTO postgis.sua_airspace VALUES ('0103000020E610000001000000040000009DA04D0E9F2D54C01FF818AC388B4240909E2287887854C0AC8F87BEBB5B42409A99999999A954C0EE0912DBDD3D4240F70489EDEE4E54C06666666666664240', 24047, 'AR328');
INSERT INTO postgis.sua_airspace VALUES ('0103000020E610000001000000050000001EA9BEF38BE15DC01AA20A7F860547400BB3D0CE695F5DC0E9263108AC04474009FB761211715CC09E7C7A6CCBF24640CDCCCCCCCC6C5CC05C02F04FA9904740D6C743DFDD6D5DC0448B6CE7FB994740', 30544, 'AR338');
...
INSERT INTO postgis.sua_airspace VALUES ('0103000020E610000001000000040

INSERT INTO postgis.sua_airspace VALUES ('0103000020E610000001000000040000007061DD78778759C0CDCCCCCCCCEC454009FB7612112959C0CDCCCCCCCC4C4540C4D155BABB0B59C09A99999999194540909E228788E858C087A3AB7477B74340', 24014, 'AR24(S)');
...
INSERT INTO postgis.sua_airspace VALUES ('0103000020E610000001000000040000000AD7A3703DDA52C07DCC07043A9D45409A999999996953C000000000008045401F85EB51B8FE53C0A69BC420B0524540022B8716D95A54C0EE0912DBDD4D4540', 23988, 'AR206L');
INSERT INTO postgis.sua_airspace VALUES ('0103000020E6100000010000000400000001DC2C5E2C215AC048E17A14AEF74240909E2287889059C0EE0912DBDD3542408E739B70AF6D59C09A999999991942403C2EAA45442459C035EB8CEF8BDD4140', 31604, 'AR312H(E)');
INSERT INTO postgis.sua_airspace VALUES ('0103000020E610000001000000040000003C2EAA45442459C035EB8CEF8BDD41408E739B70AF6D59C09A99999999194240909E2287889059C0EE0912DBDD35424001DC2C5E2C215AC048E17A14AEF74240', 31605, 'AR312H(W)');
INSERT INTO postgis.sua_airspace VALUES ('0103000020E61000000100000004000000C6FCDCD0946254C0CDCCCCCCCCBC424015FDA19927BE54C077BE9F1A2FCD42408716D9CEF76355C01B2FDD2406E94240C4D155BABBE355C0B0E595EB6DF94240', 24071, 'AR455(W)');
...
INSERT INTO postgis.sua_airspace VALUES ('0103000020E610000001000000040000000000000000805AC0EE0912DBDD5D4740909E228788E859C0DFC2BAF1EE2E47409A999999992959C0DFC2BAF1EEEE46405307793D989758C05245F12A6BB54640', 23923, 'AR106L(E)');
...
INSERT INTO postgis.sua_airspace VALUES ('0103000020E610000001000000040000000AD7A3703DDA52C07DCC07043A9D45409A999999996953C000000000008045401F85EB51B8FE53C0A69BC420B0524540022B8716D95A54C0EE0912DBDD4D4540', 23987, 'AR206H');
INSERT INTO postgis.sua_airspace VALUES ('0103000020E6100000010000000400000001DC2C5E2C215AC048E17A14AEF74240909E2287889059C0EE0912DBDD3542408E739B70AF6D59C09A999999991942403C2EAA45442459C035EB8CEF8BDD4140', 31606, 'AR312L(E)');
INSERT INTO postgis.sua_airspace VALUES ('0103000020E610000001000000040000003C2EAA45442459C035EB8CEF8BDD41408E739B70AF6D59C09A99999999194240909E2287889059C0EE0912DBDD35424001DC2C5E2C215AC048E17A14AEF74240', 31607, 'AR312L(W)');
...
INSERT INTO postgis.sua_airspace VALUES ('0103000020E610000001000000040000005E4BC8073DCC64C0904946CEC2063840A4703D0AD77D64C0DA5548F9494D37406B82A8FB005464C0919BE1067CCE3640F27B9BFEEC2B64C0A52C431CEBAA3540', 24208, 'AR904(NW)');
...
INSERT INTO postgis.sua_airspace VALUES ('0103000020E61000000100000004000000E256410C740E59C0F8C610001CA1434009FB7612112159C03333333333734440BC749318042E59C0FE47A643A7FD444009FB761211B159C0213D450E11D14540', 23967, 'AR17(N)');
INSERT INTO postgis.sua_airspace VALUES ('0103000020E61000000100000004000000909E228788E858C087A3AB7477B743405D6BEF5355FD58C0DFC2BAF1EE8E4440C4D155BABB0B59C09A999999991945407061DD78778759C0CDCCCCCCCCEC4540', 24013, 'AR24(N)');
...
INSERT INTO postgis.sua_airspace VALUES ('0103000020E6100000010000000400000009FB761211B159C0213D450E11D1454000000000005059C04529215855354540BC749318042E59C0FE47A643A7FD4440E256410C740E59C0F8C610001CA14340', 23968, 'AR17(S)');
...
INSERT INTO postgis.sua_airspace VALUES ('0103000020E61000000100000002000000E275FD82DD8463C025E99AC9371B3640BE874B8E3BBE62C0A7B393C151CA3940', 24202, 'AR901(E)');
INSERT INTO postgis.sua_airspace VALUES ('0103000020E61000000100000002000000E275FD82DD8463C025E99AC9371B3640BE874B8E3BBE62C0A7B393C151CA3940', 24203, 'AR901(W)');
...
--
-- TOC entry 3951 (class 0 OID 42609)
-- Dependencies: 221
...
(
    ...
    sua_airsp_desc character varying(35) COLLATE pg_catalog."default" NOT NULL,
    CONSTRAINT sua_airspace_type_pkey PRIMARY KEY (sua_airsp_type)
)

TABLESPACE pg_default;

ALTER TABLE postgis.sua_airspace_type
    OWNER to postgres;
...
--
-- TOC entry 3952 (class 0 OID 42612)
-- Dependencies: 222
...
(
    ...
    sua_status_desc character varying(35) COLLATE pg_catalog."default" NOT NULL,
    CONSTRAINT sua_sched_status_pkey PRIMARY KEY (sua_status)
)

TABLESPACE pg_default;

ALTER TABLE postgis.sua_sched_status
    OWNER to postgres;
...
--
-- TOC entry 3944 (class 0 OID 17462)
-- Dependencies: 214
...
(
    issued character varying COLLATE pg_catalog."default" NOT NULL,
    current character varying COLLATE pg_catalog."default",
    wind character varying COLLATE pg_catalog."default",
    visby character varying COLLATE pg_catalog."default",
    condx character varying COLLATE pg_catalog."default",
    rep_time character varying COLLATE pg_catalog."default" NOT NULL,
    stn_call character varying(5) COLLATE pg_catalog."default" NOT NULL,
    CONSTRAINT taf_pkey PRIMARY KEY (stn_call, rep_time)
)

TABLESPACE pg_default;

ALTER TABLE postgis.taf
    OWNER to postgres;

--
-- TOC entry 3949 (class 0 OID 33883)
-- Dependencies: 219
...
(
    issue_date character varying COLLATE pg_catalog."default" NOT NULL,
    proc_time character varying COLLATE pg_catalog."default" NOT NULL,
    alt1 character varying COLLATE pg_catalog."default",
    alt2 character varying COLLATE pg_catalog."default",
    alt3 character varying COLLATE pg_catalog."default",
    alt4 character varying COLLATE pg_catalog."default",
    alt5 character varying COLLATE pg_catalog."default",
    alt6 character varying COLLATE pg_catalog."default",
    alt7 character varying COLLATE pg_catalog."default",
    alt8 character varying COLLATE pg_catalog."default",
    alt9 character varying COLLATE pg_catalog."default",
    dir1 character varying COLLATE pg_catalog."default",
    dir2 character varying COLLATE pg_catalog."default",
    dir3 character varying COLLATE pg_catalog."default",
    dir4 character varying COLLATE pg_catalog."default",
    dir5 character varying COLLATE pg_catalog."default",
    dir6 character varying COLLATE pg_catalog."default",
    dir7 character varying COLLATE pg_catalog."default",
    dir8 character varying COLLATE pg_catalog."default",
    dir9 character varying COLLATE pg_catalog."default",
    spd1 character varying COLLATE pg_catalog."default",
    spd2 character varying COLLATE pg_catalog."default",
    spd3 character varying COLLATE pg_catalog."default",
    spd4 character varying COLLATE pg_catalog."default",
    spd5 character varying COLLATE pg_catalog."default",
    spd6 character varying COLLATE pg_catalog."default",
    spd7 character varying COLLATE pg_catalog."default",
    spd8 character varying COLLATE pg_catalog."default",
    spd9 character varying COLLATE pg_catalog."default",
    temp1 character varying COLLATE pg_catalog."default",
    temp2 character varying COLLATE pg_catalog."default",
    temp3 character varying COLLATE pg_catalog."default",
    temp4 character varying COLLATE pg_catalog."default",
    temp5 character varying COLLATE pg_catalog."default",
    temp6 character varying COLLATE pg_catalog."default",
    temp7 character varying COLLATE pg_catalog."default",
    temp8 character varying COLLATE pg_catalog."default",
    temp9 character varying COLLATE pg_catalog."default",
    stn_call character varying(5) COLLATE pg_catalog."default" NOT NULL,
    CONSTRAINT winds_pkey PRIMARY KEY (stn_call, issue_date)
)

TABLESPACE pg_default;

ALTER TABLE postgis.winds
    OWNER to postgres;

-- Completed on 2021-06-29 16:54:12 EDT
